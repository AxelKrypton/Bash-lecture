...
\begin{exercise}[Inspirational]{A taste of awk and sed}
    ...
    \URL[Blue]{https://github.com/AxelKrypton/Bash-lecture/tree/main/Bash/Exercise\_Sheet\_5/LQCD.dat}{Here} you can find a chunk of the standard output of a LQCD simulation, in particular measurements lines, only.
