...
\begin{exercise}[Inspirational]{A taste of awk and sed}
    ...
    \URL[Blue]{https://github.com/AxelKrypton/Bash_lecture_2019/blob/master/TeX/Exercises/Case.tex}{Here} you can find a chunk of the standard output of a LQCD simulation, in particular measurements lines, only.
