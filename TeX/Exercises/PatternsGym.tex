...
\begin{exercise}[Inspirational]{Patterns gym}
    ...
    Here \bash|rename| refers to the Perl script and not to the tool from the \texttt{util-linux} package (indeed, there is \URL[blue]{https://unix.stackexchange.com/a/275278/370049}{some possible confusion}).
