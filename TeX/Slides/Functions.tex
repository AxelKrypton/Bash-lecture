...
\begin{frame}[fragile]{How do I return something from a function?}
        ...
        \begin{enumerate}
            ...
            \item<only@4-> Global variables
                           \begin{itemize}[<only@{4,7}>]
                               ...
                               \item[\crossmark] if the function is executed in a subshell, the method fails! \Remark{Mitigated by new Bash v5.3 command expansion \PB{\texttt{\$\{ ...; \}}}}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north east, draw=ALERT, rounded corners, font=\Large, visible on=<2->]
        at ($(current page.north east)-(5mm,2.5mm)$) {It's simple: \alert{You don't!}};
    \end{tikzpicture}
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
