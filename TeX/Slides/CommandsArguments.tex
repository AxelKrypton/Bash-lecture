...
\begin{frame}[fragile]{How does Bash interpret a line of code?}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[font=\tiny, anchor=south] at (current page.south) {$^\star$There are a few advanced cases, such as commands that span multiple lines, that have slightly different rules.};
