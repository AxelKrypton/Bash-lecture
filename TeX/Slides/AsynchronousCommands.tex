...
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}{Process Management: Conclusions\hfill\uncover<2>{\small\URL[PB]{https://www.quora.com/What-is-the-difference-between-the-SIGINT-and-SIGTERM-signals-in-Linux-What\%E2\%80\%99s-the-difference-between-the-SIGKILL-and-SIGSTOP-signals}{SIGTERM vs SIGKILL cartoon}}}
    \vspace{-3mm}
    \begin{itemize}
        \setlength{\itemsep}{1mm}
        \item It is a potentially tough world: Be scared but not too much
        \item Bash might not be the most indicate tool
        ...
        \end{enumerate}
    \end{itemize}
    \begin{varblock}{quote}[\textwidth]{About using $\;$\bash|kill -9|}[Greg's Wiki]<2>
    ...
    \end{varblock}
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north east] at ($(current page.north east)-(8mm,3mm)$) {};
    \end{tikzpicture}
\end{frame}
