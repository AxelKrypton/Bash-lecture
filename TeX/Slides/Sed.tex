...
\begin{frame}{Sed: A marvellous utility}
    ...
    \begin{lrbox}{\tmpbox}
        \begin{minipage}{0.75\textwidth}
            \URL[PB]{https://www.gnu.org/software/sed/manual}{The official GNU manual} \Remark{The PDF of \PB{v4.10} is 88 pages long\ldots}\\
            ...
            \URL[PT]{https://www.pement.org/sed/sed1line.txt}{One-liners, with some comments}\\
...
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}[fragile]{The PDF manual is 88 pages long. What should I learn here?}
    \vspace{-3mm}
    \begin{itemize}
...
\begin{frame}[fragile]{The main commands: Delete}
    ...
    \begin{lstlisting}[style=MyBash]
        ...
        # Print only lines with less than 65 characters
        $ sed '/^.\{65\}/d' filename
    \end{lstlisting}
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
