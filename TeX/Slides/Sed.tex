...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}{Sed: A marvelous utility}
    \vspace{-3mm}
    ...
    \begin{varblock*}{}[0.76\textwidth]{Some references}
        \URL[PB]{https://www.gnu.org/software/sed/manual}{The official GNU manual} {\tiny\{~The PDF is 85 pages long\ldots~\}}\\
        \URL[PS]{http://www.grymoire.com/Unix/Sed.html\#uh-0}{A very nice tutorial} {\tiny\{~Bash code there often uses deprecated features, but you should know it by now!~\}}\\
    ...
    \begin{varblock}{quote}[\textwidth]{A command can be limited to some lines using restrictions}
        \vspace{-2mm}\textnormal{
            \begin{itemize}
                ...
                \item A regular expression \PP{\texttt{/regex/}} or \PP{\texttt{\textbackslash$\bullet$regex$\bullet$}} where \PP{$\bullet$} is any character {\tiny\{~not to be matched!~\}}
...
\begin{frame}[fragile]{The main commands: Print}
    ...
    \begin{itemize}
        ...
        \item Hence, this command is usually only used in conjunction with the \bash|-n| command-line option of \bash|sed| (whose long name is \texttt{--quite} or \texttt{--silent})
