...
\begin{frame}{Awk: Another marvellous utility}
    ...
    \begin{lrbox}{\tmpbox}
        \begin{minipage}{0.85\textwidth}
            ...
            $\quad$\URL[PB]{https://www.gnu.org/software/gawk/manual/}{The official GNU manual} \Remark{The PDF is \alert{581} pages long\ldots}\\
...
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}[fragile]{The PDF manual is 581 pages long!! What should I learn here?}
    \vspace{-4mm}
    \begin{itemize}
