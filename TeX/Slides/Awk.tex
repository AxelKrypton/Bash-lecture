...
\begin{frame}{Awk: Another marvellous utility}
    ...
    \begin{lrbox}{\tmpbox}
        \begin{minipage}{0.85\textwidth}
            ...
            $\quad$\URL[PB]{https://www.gnu.org/software/gawk/manual/}{The official GNU manual} \Remark{The PDF of \PB{v5.4} is \alert{622} pages long\ldots}\\
...
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}[fragile]{The PDF manual is 622 pages long!! What should I learn here?}
    \vspace{-2mm}
    \begin{itemize}
...
\begin{frame}[fragile]{A (very limited) taste of \bash|awk| by examples}
    ...
    \begin{onlyenv}<2>
        ...
        \begin{varblock}{alert}[0.8\textwidth]{}
            ...
            You can even write full \texttt{.awk} scripts.
        \end{varblock}
    \end{onlyenv}
    \begin{onlyenv}<3>
        \begin{lstlisting}[style=MyBash, numbers=none, xleftmargin=3mm, xrightmargin=3mm]
