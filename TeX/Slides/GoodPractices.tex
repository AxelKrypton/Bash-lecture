    ...
    \begin{varblock*}{quote}[0.88\textwidth]{}
        ...
        \begin{columns}[c]
            ...
            \begin{column}{0.46\textwidth}
                \centering
                Bash \PQ{v2.0} $\;\longrightarrow\;$ Released in \PQ{12.1996}\\
                Bash \PT{v3.0} $\;\longrightarrow\;$ Released in \PT{08.2004}\\
                Bash \PT{v3.1} $\;\longrightarrow\;$ Released in \PT{12.2005}\\
                Bash \PT{v3.2} $\;\longrightarrow\;$ Released in \PT{10.2006}\\
                Bash \PP{v4.0} $\;\longrightarrow\;$ Released in \PP{02.2009}\\
                Bash \PP{v4.1} $\;\longrightarrow\;$ Released in \PP{12.2009}\\
                Bash \PP{v4.2} $\;\longrightarrow\;$ Released in \PP{02.2011}\\
                Bash \PP{v4.3} $\;\longrightarrow\;$ Released in \PP{02.2014}
            \end{column}
            \begin{column}{0.46\textwidth}
                \centering
                \PB{\scriptsize Best for empty arrays and \texttt{-u} shell option:\\[1mm]}
                Bash \PS{v4.4} $\;\longrightarrow\;$ Released in \PS{09.2016}\\
                Bash \PS{v5.0} $\;\longrightarrow\;$ Released in \PS{01.2019}\\
                Bash \PS{v5.1} $\;\longrightarrow\;$ Released in \PS{12.2020}\\
                Bash \PS{v5.2} $\;\longrightarrow\;$ Released in \PS{09.2022}
            \end{column}
            \qquad
        \end{columns}
    \end{varblock*}
