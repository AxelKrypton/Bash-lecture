...
\begin{frame}[fragile]{Require a minimum Bash version}
        ...
        \begin{columns}[c]
            ...
            \begin{column}{0.46\textwidth}
                ...
                \begin{tabular}{l@{$\;\longrightarrow\;$}l}
                    ...
                    Bash \PS{v5.3} & Released in \PS{07.2025}\\
                \end{tabular}
            \end{column}
            \qquad
        \end{columns}
    ...
    \begin{lstlisting}[style=MyBash, numbers=none]
        ...
        |+5 3 15 1 release aarch64-apple-darwin21.6.0
        5.3.15(1)-release+|
        $ tr ' ' '.' <<< "${BASH_VERSINFO[@]:0:3}"
        |+5.3.15+|
        # You can use the 'type' builtin to check command existence
    \end{lstlisting}
    \PrepareURLsymbol[PB]
...
\begin{frame}{Being aware is the first step}
    ...
    \begin{lrbox}{\tmpbox}
        \begin{minipage}{0.85\textwidth}
            \URL[PT]{http://mywiki.wooledge.org/BashPitfalls}{Bash Pitfalls}\Remark[1em]{65 discussed items}\\
