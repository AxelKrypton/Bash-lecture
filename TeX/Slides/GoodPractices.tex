...
\begin{frame}[fragile]{Never do anything along these lines in your scripts!}
    \begin{enumerate}
        ...
        \item<only@3>
            ...
            \FrameRemark[3]{\guillemotleft The command substitution \;\PB{\texttt{\$(cat file)}}\; can be replaced by the equivalent but faster \;\PB{\texttt{\$(< file)}}\guillemotright. $\;\to\;$ \URL[PB]{https://www.gnu.org/software/bash/manual/html\_node/Command-Substitution.html}{Bash manual section 3.5.4}}
        \item<only@4>
