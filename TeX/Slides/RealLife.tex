...
\begin{frame}[fragile]{A wide-audience support script: \URL[PB]{https://github.com/AxelKrypton/BashLogger}{A Bash Logger}}
    \begin{overlayarea}{\textwidth}{0.8\textheight}
        ...
        \begin{itemize}[<only@1>]
            ...
            \item \PS{Messages are printed to a given file descriptor (customizable at source time)}\\
            ...
            \item \PS{Fatal errors exit with a given exit code (customizable at source time)}\\
            ...
            \item Each printing function has a small interface to e.g.\ omit the label or the \bash|\n| at the end
        ...
        \begin{onlyenv}<3-5>
            ...
            \begin{center}
                ...
                \uncover<4->{\includegraphics[width=0.88\textwidth]{BashLogger_output_minimal}}\\[-1pt]
                \uncover<5>{\includegraphics[width=0.88\textwidth]{BashLogger_output_errors}}
            \end{center}
        \end{onlyenv}
    \end{overlayarea}
...
\begin{frame}[fragile]{Another remarkable handler: \URL[PB]{https://smash-transport.github.io/smash-vhlle-hybrid/develop/}{SMASH-vHLLE-Hybrid}}
    \vspace{-3mm}
    \begin{center}
        \includegraphics[height=0.6\textheight, clip, trim=0 0 0 5mm]{SMASH-vHLLE-Hybrid}
    \end{center}
    \vspace{-2mm}
    \begin{itemize}
        \item Another example of large Bash project, $\mathcal{O}$(10$^\text{4}$) lines of code
        \item Own test framework \PS{with unit, integration and functional tests}
