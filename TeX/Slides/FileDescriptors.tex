...
\begin{frame}[fragile]{Process substitution}
    ...
    \end{onlyenv}
    \PrepareURLsymbol[PB]
    \FrameRemark<2>{$^\star$This is an incomplete statement, if taken as general rule: It is not \URL*{https://unix.stackexchange.com/questions/403783/the-process-substitution-output-is-out-of-the-order}{the full story}.}
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
