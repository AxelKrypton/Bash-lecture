...
\begin{frame}[c]{Lecture format}
    \begin{center}
        \begin{tikzpicture}[every node/.style={inner xsep=0}]
            ...
            \node[right = of A2] {
                \begin{tabular}{@{}r@{\;}l}
                    Morning:   & ITP, room 00.111 \\
                    Afternoon: & ITP, room 00.111 \Remark{First together, then alone}
                \end{tabular}
            };
...
\begin{frame}{References for future use}
    ...
    \begin{itemize}
        ...
        \item[] \URL[PS]{http://mywiki.wooledge.org/BashGuide}{Bash Guide}\PB{\Remark{Very precise guide, not completely from zero, though}} \tikzmark{TutorialEnd}
...
\begin{frame}{What will we explore?}
    ...
    \begin{multicols}{2}
        \begin{enumerate}
            ...
            \item \tc<2>{Tuesday}{Shell options and flow control}
            ...
            \item \tc<2>{Tuesday}{GNU Coreutils}
            ...
            \item \tc<2>{Thursday}{The GNU Readline library}
            \item \tc<2>{Friday}{Awk}
            \item \tc<2>{Friday}{An interactive summary}
            \item \tc<2>{Friday}{Some good practices}
