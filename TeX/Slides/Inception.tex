...
\begin{frame}{The goal of the day}
    ...
    \end{tikzpicture}
    \FrameRemark[2]{Some slides will unavoidably refer to later material: Hopefully, everything will be clarified at the end of the day and, for sure, by Friday!}
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
