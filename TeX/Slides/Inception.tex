...
\begin{frame}{An often mistreated language}
    ...
    \begin{varblock}{alerted}[0.8\textwidth]{The nature of Bash}
        \PQ{As for many tools, it is common to just get stuff working, no matter how}
    \end{varblock}
    %\vspace{2mm}
...
\begin{frame}{The goal of the day}
    \begin{itemize}
        ...
        \item Parameters expansion
        \item \alert<2>{Word splitting}\tikzmark{ptC}
        \item Command line arguments
        \item Globbing
        \item Regular expressions
        \item Brace expressions
        \item \bash|if| and \bash|test|
    \end{itemize}
    \begin{tikzpicture}[remember picture, overlay]
        \coordinate (remark) at ($(ptA)!0.5!(ptC)+(3cm,0)$);
        ...
        \node[below = 25mm of cloud, text=PP, visible on=<2>, rounded corners=3pt, draw=PB, thick, inner sep=2mm] (learn) {Take your time and learn them well!};
