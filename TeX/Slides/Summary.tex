...
\begin{frame}[fragile]{Quiz time (III) -- Day 1}
    ...
    \begin{quiz}[1]{What does the above command print?}
        ...
        \correctChoice{\texttt{\{1..30\}} gets printed since brace expansion happens before command substitution.}
...
\begin{frame}[fragile]{Quiz time (IX) -- Day 4}
    ...
    \begin{quiz}[1]{What does the command above do?}
        ...
        \wrongChoice{Using \texttt{\&;} the shell will queue the \bash|sleep| commands and execute them after each other in background.}
