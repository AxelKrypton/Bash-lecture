...
\begin{frame}[fragile]{Quiz time (II) -- Day 1}
    ...
    \begin{uncoverenv}<3-4>
        ...
        \end{lstlisting}
        \begin{quiz}[3]{What does the above function do? Is it good code?}
...
\begin{frame}[fragile]{Quiz time (III) -- Day 1}
    ...
    \begin{quiz}[1]{What does the above command print today?}
        ...
        \correctChoice{\texttt{\{1..26\}} gets printed since brace expansion happens before command substitution.}
