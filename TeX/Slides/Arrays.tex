...
\begin{frame}[fragile]{Iterating over array elements}
    ...
    \begin{itemize}
        ...
        \item When iterating over the \textbf{\PP{elements}}, 99\% of the times you will need \,\tc{strings-color}{\texttt{"\$\{array[@]\}"}}
        \item When iterating over the \textbf{\PP{indices}}, 99\% of the times you will need \,\tc{strings-color}{\texttt{"\$\{!array[@]\}"}}
...
\begin{frame}[fragile]{Deleting arrays or array elements}
    ...
    \begin{onlyenv}<1>
        \begin{itemize}
            \item To delete an element of an array, pass it to the \bash{unset} built-in
        \end{itemize}
...
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
\begin{frame}{Associative arrays: Remarks}{Since Bash v4.0 (2009)}
    \begin{itemize}
        \item
    \end{itemize}
\end{frame}
