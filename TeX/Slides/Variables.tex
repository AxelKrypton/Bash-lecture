...
\begin{frame}[fragile]{Crucial to know (II)}{\ldots{}and not to forget!}
    ...
    \end{varblock}
    \FrameRemark<6>{With time you will learn how omitting double quoting expansion can be used to your advantage. This should be emphasised in a comment, though.}
\end{frame}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%
