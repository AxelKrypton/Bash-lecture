    ...
    \begin{center}
        \resizebox{!}{0.8\textheight}{
            \begin{tikzpicture}
                ...
                \uncover<7->{\pyramidLayer[Teach others]{A}{1.2}{5.5}{red}{90\%};}
                \uncover<6->{\pyramidLayer[Practice doing]{B}{1.2}{4.8}{PB}{75\%};}
                \uncover<5->{\pyramidLayer[Discussion]{C}{1.2}{4.1}{orange!30!yellow}{50\%};}
                \uncover<4->{\pyramidLayer[Demonstration]{D}{1.2}{3.4}{PS}{30\%};}
                \uncover<3->{\pyramidLayer[Audiovisual]{E}{1.2}{2.7}{PP}{20\%};}
                \uncover<2->{\pyramidLayer[Reading]{F}{1.2}{2.0}{PT}{10\%};}
                \uncover<1->{\pyramidLayer[Lecture]{G}{1.2}{1.3}{magenta}{5\%};}
    ...
    \begin{columns}[c]
        \begin{column}{0.3\textwidth}
            \begin{tikzpicture}
                ...
                \begin{scope}[scope on=<2>]
                    ...
                    \path[overlay, from] (fig.north east) ++(2pt,2pt) edge[out=45, in=180] node[pos=1, right=2pt, font=\scriptsize, text=PS] {Well, with some more practice, I would say!} ++(6mm,4pt);
                \end{scope}
            \end{tikzpicture}
        \end{column}
        \begin{column}{0.5\textwidth}
            ...
            \begin{varblock}{quote}[\textwidth]{}<2>
                \normalfont
                You need practice to digest most of aspects and \textbf{your job offers plenty of possibility for that!}
            \end{varblock}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{So, what should I do now?}
    ...
    \begin{overlayarea}{\textwidth}{0.7\textheight}
        \begin{enumerate}
            ...
            \item<only@1->
                \PB{\textbf{It is matter of doing small steps!}}
                \begin{itemize}
                ...
                \end{itemize}
            \item<only@2->
                \PS{\textbf{I hope you enjoyed the course}}
                \begin{itemize}
                    ...
                    \item Feel free to send me an email \,\PS{\href{mailto:sciarra@itp.uni-frankfurt.de}{{\small\Letter}}}
                          ...
                          \end{itemize}
                \end{itemize}
            \item<only@3-> Last but not least, \PP{\textbf{haven't you already planned your trip to Iceland?}} $\;$\raisebox{-1pt}{\includegraphics[height=12pt]{Yum}}
        \end{enumerate}
        \begin{onlyenv}<2>
            \begin{center}
                \includegraphics[height=0.26\textheight]{TiredButHappy}\hfill
                \includegraphics[height=0.26\textheight]{Skeptical}\hfill
                \includegraphics[height=0.26\textheight]{Wonder}\hfill
                \includegraphics[height=0.26\textheight, clip, trim=35mm 0 0 0]{Wow}
            \end{center}
        \end{onlyenv}
    \end{overlayarea}
