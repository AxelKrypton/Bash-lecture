...
emphstyle=[3]{\color{Goldenrod}}, %Loops, if, etc.
emph=[4]{return, exit},
emphstyle=[4]{\color{DodgerBlue}}, %Logical keywords
emph=[6]{PATH, SHELL},
...
emphstyle=[7]{\color{DarkSlateBlue}}, %Shell built-in
emph=[8]{man, apropos},
emphstyle=[8]{\color{violet}}, %(External) commands
}
