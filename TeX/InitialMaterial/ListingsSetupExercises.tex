...
emph=[1]{PrintInfo, PrintWarning, PrintError, Logger, F1, F2, F3, Simulate, Monitor,
         Time_Concurrent_Burn, Scan_Times, Burn_Cpu},
emphstyle=[1]{\color{functions-color}}, %Functions
emph=[2]{a, msg, filename, array, string, index, simulationPid, sleepTime, word},
...
emph=[6]{echo, printf, touch, whoami, rename, prename, mv, seq, shuf, factor, rev, sort, cut, column, columns, paste,
         awk, sed, sleep, pdflatex, nproc},
