...
emph=[1]{CreateListOfFiles, LevelOne, LevelTwo, LevelThree, Test, SecondsToTimeStringWithDays, ExampleFunction,
         ...
         CountTill5From, FifthElementOf, CreateAuxiliaryFiles, CleanAuxiliaryFiles, Failure, FailureMsg, Simulation, Bomb, Join, Main, Enable_Desired_Shell_Behaviour, Define_Global_Variables, Print_Helper_And_Exit_If_Requested, Parse_Type_Of_Tests, Define_Available_Tests, Parse_Command_Line_Parameters, Run_Tests, Print_Tests_Report, Exit_With_Tests_Outcome_Dependent_Exit_Code, Burn_Cpu, Is_Odd, Define_Available_Tests},
...
emph=[6]{man, apropos, ls, rm, g++, chmod, cp, awk, sed, cut, perl, args, date, grep, sleep, tput, seq, cat, wc, sort, uniq, tail,
         ...
         egrep, shuf, stat, find, fgrep, bc, tr, paste, expr, diff, touch, a_command, git, yq, jq, tee, nproc},
